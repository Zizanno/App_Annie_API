...
folder = 'files/'
filename = 'retention_downloads_monthly_'
gcp_bucket = 'appannie_rnd_retention_hist'
# today = datetime.now()
...
api_request = 'https://api2.appannie.com/v2/bulk/get-bulk-urls?metric_bundles=usage_product_level_professional&country_codes=all&unified_category_group=all_games&granularity=monthly&start_date={}&end_date={}'
...
def get_appanie_data(START, END):
    ...
    l =r_urls
    split_1=[i.split('/monthly/', 1)[1] for i in l]
